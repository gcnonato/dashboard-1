...
use AnyTv\map\CategoryTableMap;

/**
 * Base static class for performing query and update operations on the 'anytv_category' table.
 *
 *
 *
...
abstract class BaseCategoryPeer
{
    ...
    const TABLE_NAME = 'anytv_category';

    /** the related Propel class for this table */
    const OM_CLASS = 'AnyTv\\Category';
    ...
    const ID = 'anytv_category.id';

    /** the column name for the name field */
    const NAME = 'anytv_category.name';

    /** the column name for the description field */
    const DESCRIPTION = 'anytv_category.description';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to anytv_category
    ...
    /**
     * Deletes all rows from the anytv_category table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
