...
/**
 * Base class that represents a row from the 'anytv_category' table.
 *
 *
 *
...
abstract class BaseCategory extends BaseObject implements Persistent
{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `anytv_category` (%s) VALUES (%s)',
    ...
    public function setOffers(PropelCollection $offers, PropelPDO $con = null)
    {
        ...
        $this->offersScheduledForDeletion = unserialize(serialize($offersToDelete));

        foreach ($offersToDelete as $offerRemoved) {
            $offerRemoved->setCategory(null);
        }
