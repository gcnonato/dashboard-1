...
/**
 * Base class that represents a query for the 'anytv_tag' table.
 *
 *
 *
 ...
 * @method TagQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method TagQuery groupById() Group by the id column
 * @method TagQuery groupByName() Group by the name column
 * @method TagQuery groupByDescription() Group by the description column
 *
 ...
 *
 * @method TagQuery leftJoinTagCloud($relationAlias = null) Adds a LEFT JOIN clause to the query using the TagCloud relation
 * @method TagQuery rightJoinTagCloud($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TagCloud relation
 * @method TagQuery innerJoinTagCloud($relationAlias = null) Adds a INNER JOIN clause to the query using the TagCloud relation
 *
 ...
 * @method Tag findOneByDescription(string $description) Return the first Tag filtered by the description column
 *
 * @method array findById(string $id) Return Tag objects filtered by the id column
 * @method array findByName(string $name) Return Tag objects filtered by the name column
 * @method array findByDescription(string $description) Return Tag objects filtered by the description column
 *
...
abstract class BaseTagQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'anytv_offers', $modelName = 'AnyTv\\Tag', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `description` FROM `anytv_tag` WHERE `id` = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TagPeer::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByTagCloud($tagCloud, $comparison = null)
    {
        if ($tagCloud instanceof TagCloud) {
            return $this
                ->addUsingAlias(TagPeer::ID, $tagCloud->getTagId(), $comparison);
