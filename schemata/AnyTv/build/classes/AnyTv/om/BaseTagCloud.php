...
/**
 * Base class that represents a row from the 'anytv_tagcloud' table.
 *
 *
 *
 * @package    propel.generator.AnyTv.om
 */
abstract class BaseTagCloud extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AnyTv\\TagCloudPeer';
     ...
     * @return TagCloud The current object (for fluent API support)
     */
    public function setOfferId($v)
    {
        ...
        if ($this->offer_id !== $v) {
            $this->offer_id = $v;
            $this->modifiedColumns[] = TagCloudPeer::OFFER_ID;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = TagCloudPeer::TAG_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->offer_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->tag_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = TagCloudPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TagCloud object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TagCloudPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TagCloudQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TagCloudPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TagCloudPeer::OFFER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`offer_id`';
        }
        if ($this->isColumnModified(TagCloudPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`tag_id`';
        }

        $sql = sprintf(
            'INSERT INTO `anytv_tagcloud` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`offer_id`':
                        $stmt->bindValue($identifier, $this->offer_id, PDO::PARAM_STR);
                        break;
                    case '`tag_id`':
                        $stmt->bindValue($identifier, $this->tag_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TagCloudPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TagCloudPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TagCloud'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TagCloud'][serialize($this->getPrimaryKey())] = true;
        $keys = TagCloudPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setOfferId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagCloudPeer::OFFER_ID)) $criteria->add(TagCloudPeer::OFFER_ID, $this->offer_id);
        if ($this->isColumnModified(TagCloudPeer::TAG_ID)) $criteria->add(TagCloudPeer::TAG_ID, $this->tag_id);
    ...
    {
        $criteria = new Criteria(TagCloudPeer::DATABASE_NAME);
        $criteria->add(TagCloudPeer::OFFER_ID, $this->offer_id);
        $criteria->add(TagCloudPeer::TAG_ID, $this->tag_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOfferId()) && (null === $this->getTagId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TagCloud (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TagCloud Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aOffer === null && (($this->offer_id !== "" && $this->offer_id !== null)) && $doQuery) {
    ...
    {
        if ($this->aTag === null && (($this->tag_id !== "" && $this->tag_id !== null)) && $doQuery) {
    ...
    {
        return (string) $this->exportTo(TagCloudPeer::DEFAULT_STRING_FORMAT);
    }
