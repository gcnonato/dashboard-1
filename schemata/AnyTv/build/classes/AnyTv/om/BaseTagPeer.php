...
use AnyTv\Tag;
use AnyTv\TagPeer;
use AnyTv\map\TagTableMap;

/**
 * Base static class for performing query and update operations on the 'anytv_tag' table.
 *
 *
 *
...
abstract class BaseTagPeer
{
    ...
    const TABLE_NAME = 'anytv_tag';

    /** the related Propel class for this table */
    const OM_CLASS = 'AnyTv\\Tag';
    ...
    const ID = 'anytv_tag.id';

    /** the column name for the name field */
    const NAME = 'anytv_tag.name';

    /** the column name for the description field */
    const DESCRIPTION = 'anytv_tag.description';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (TagPeer::ID, TagPeer::NAME, TagPeer::DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (TagPeer::ID => 0, TagPeer::NAME => 1, TagPeer::DESCRIPTION => 2, ),
    ...
    /**
     * Method to invalidate the instance pool of all tables related to anytv_tag
    ...
    /**
     * Deletes all rows from the anytv_tag table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
